...
ROM_START(another)
    ...
    ROM_LOAD("another.bin", 0x000000, 0x00010000, BAD_DUMP CRC(0eef4a25) SHA1(0d63281839eac90dd15b107c33443cb05bf84ba0))

    ROM_REGION32_BE(0x00002000, "ae_config", ROMREGION_ERASEFF)
    ROM_LOAD("ae_config", 0x00000000, 0x00002000, BAD_DUMP CRC(0eef4a25) SHA1(0d63281839eac90dd15b107c33443cb05bf84ba0))
ROM_END
